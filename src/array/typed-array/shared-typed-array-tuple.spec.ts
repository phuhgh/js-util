...
describe("SharedTypedArrayTuple", () =>
{
    ...
    describe("=> Range2d.f32", () =>
    {
        it("| creates, writes, reads and destroys without triggering the asan", () =>
        {
            ...
            const sharedTuple = SharedTypedArrayTuple.createOne(Range2d.f32, testModule.wrapper);
    ...
    describe("=> Range2d.f32", () =>
    {
        it("| creates, writes, reads and destroys without triggering the asan", () =>
        {
            ...
            const sharedTuple = SharedTypedArrayTuple.createOne(Range2d.u8, testModule.wrapper);
            sharedTuple.copyToBuffer(testRange);
