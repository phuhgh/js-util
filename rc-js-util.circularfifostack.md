...
|  [pop()](./rc-js-util.circularfifostack.pop.md) |  | Remove the first inserted element in the stack and return it. |
|  [push(value)](./rc-js-util.circularfifostack.push.md) |  | Pushes a value to the front of the stack (depending on <code>mode</code>). |
