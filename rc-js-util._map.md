...
|  [intersect](./rc-js-util._map.intersect.md) | <code>static</code> | typeof mapIntersect | <p>Does not check value equality, only key. Takes items from A.</p><p>See [mapIntersect()](./rc-js-util.mapintersect.md)<!-- -->.</p> |
