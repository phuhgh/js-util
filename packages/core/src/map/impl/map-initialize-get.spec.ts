...
describe("=> mapInitializeGet", () =>
{
    ...
    test("| returns the value where available", () =>
    {
    ...
    test("| returns the value of the callback where no value", () =>
    {
        const values: Map<"a" | "b" | "c" | "d", 1 | 2 | 3 | 4 | 5> = new Map([["a", 1], ["b", 2], ["c", 3]]);
    ...
    {
        test("| doesn't allow keys and values not supported by the map", () =>
        {
            const values: Map<"a" | "b" | "c" | "d", 1 | 2 | 3 | 4 | 5> = new Map([["a", 1], ["b", 2], ["c", 3]]);
