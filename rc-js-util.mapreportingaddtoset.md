...
[Home](./index.md) &gt; [rc-js-util](./rc-js-util.md) &gt; [mapReportingAddToSet](./rc-js-util.mapreportingaddtoset.md)
...
```typescript
export declare function mapReportingAddToSet<TKey, TValue>(map: Map<TKey, Set<TValue>>, key: TKey, value: TValue): boolean;
```
